package com.fintrace.app.data.database.converter

import androidx.room.TypeConverter
import com.fintrace.app.data.database.entity.PendingTransactionStatus
import com.fintrace.app.data.database.entity.SubscriptionState
...
class Converters {
    ...
    @TypeConverter
    fun fromPendingTransactionStatus(value: PendingTransactionStatus): String {
        return value.name
    }

    @TypeConverter
    fun toPendingTransactionStatus(value: String): PendingTransactionStatus {
        return PendingTransactionStatus.valueOf(value)
    }
}