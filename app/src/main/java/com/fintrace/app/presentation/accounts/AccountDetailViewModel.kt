...
import com.fintrace.app.data.currency.CurrencyConversionService.TransactionData
...
import com.fintrace.app.ui.components.BalancePoint
        ...
        viewModelScope.launch {
            combine(
                ...
                filteredTransactions.forEach { transaction ->
                    ...
                    if (transaction.transactionType == com.fintrace.app.data.database.entity.TransactionType.INCOME) {
