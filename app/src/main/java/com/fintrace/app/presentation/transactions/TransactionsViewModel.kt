...
import com.fintrace.app.presentation.common.getDateRangeForPeriod
import com.fintrace.app.presentation.common.CurrencyGroupedTotals
import com.fintrace.app.presentation.common.CurrencyTotals
...
class TransactionsViewModel @Inject constructor(
    ...
    private val userPreferencesRepository: com.fintrace.app.data.preferences.UserPreferencesRepository,
    ...
    private val _amountFilter = MutableStateFlow<com.fintrace.app.ui.screens.analytics.AmountFilter?>(null)
    val amountFilter: StateFlow<com.fintrace.app.ui.screens.analytics.AmountFilter?> = _amountFilter.asStateFlow()
    ...
    fun setAmountFilter(operator: com.fintrace.app.ui.screens.analytics.AmountOperator?, value: BigDecimal?) {
        _amountFilter.value = if (operator != null && value != null) {
            com.fintrace.app.ui.screens.analytics.AmountFilter(operator, value)
        } else {
            null
        }
    }
    ...
    private fun getFilteredTransactions(
        ...
        amountFilter: com.fintrace.app.ui.screens.analytics.AmountFilter? = null,
            ...
            merchantFilteredFlow.map { transactions ->
                transactions.filter { transaction ->
                    when (amountFilter.operator) {
                        com.fintrace.app.ui.screens.analytics.AmountOperator.EQUALS ->
                            transaction.amount.compareTo(amountFilter.value) == 0
                        com.fintrace.app.ui.screens.analytics.AmountOperator.GREATER_THAN ->
                            transaction.amount > amountFilter.value
                        com.fintrace.app.ui.screens.analytics.AmountOperator.LESS_THAN ->
                            transaction.amount < amountFilter.value
                        com.fintrace.app.ui.screens.analytics.AmountOperator.GREATER_THAN_OR_EQUAL ->
                            transaction.amount >= amountFilter.value
                        com.fintrace.app.ui.screens.analytics.AmountOperator.LESS_THAN_OR_EQUAL ->
                            transaction.amount <= amountFilter.value
                    }
                }
            }
    ...
    private fun calculateCurrencyGroupedTotals(transactions: List<TransactionEntity>): CurrencyGroupedTotals {
        ...
        val filteredAvailableCurrencies = CurrencyFormatter.sortCurrencies(
