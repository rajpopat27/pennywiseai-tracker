...
import com.fintrace.app.ui.MainScreen
...
fun FintraceNavHost(
    ...
    NavHost(
        ...
        composable<Permission>(
            ...
            com.fintrace.app.ui.screens.PermissionScreen(
                onPermissionGranted = {
        ...
        composable<Settings>(
            ...
            com.fintrace.app.ui.screens.settings.SettingsScreen(
        ...
        composable<TransactionDetail>(
            ...
            com.fintrace.app.presentation.transactions.TransactionDetailScreen(
        ...
        composable<AddTransaction>(
            ...
            com.fintrace.app.presentation.add.AddScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable<Rules>(
            ...
            com.fintrace.app.ui.screens.rules.RulesScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable<CreateRule>(
            ...
            val rulesViewModel: com.fintrace.app.ui.viewmodel.RulesViewModel = hiltViewModel()
            ...
            com.fintrace.app.ui.screens.rules.CreateRuleScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
                onSaveRule = { rule ->
        ...
        composable<AccountDetail>(
            ...
            com.fintrace.app.presentation.accounts.AccountDetailScreen(
                navController = navController
            )
        }
        ...
        composable<PendingTransactions>(
            ...
            com.fintrace.app.presentation.pending.PendingTransactionsScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable<PendingTransactionReview>(
            ...
            com.fintrace.app.presentation.pending.PendingTransactionReviewScreen(
