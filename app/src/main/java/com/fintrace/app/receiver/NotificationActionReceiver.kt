...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_DELETE_TRANSACTION = "com.fintrace.app.ACTION_DELETE_TRANSACTION"
        const val ACTION_CONFIRM_TRANSACTION = "com.fintrace.app.ACTION_CONFIRM_TRANSACTION"
        const val ACTION_CHANGE_CATEGORY = "com.fintrace.app.ACTION_CHANGE_CATEGORY"
    ...
    private fun deleteTransaction(context: Context, transactionId: Long, notificationId: Int) {
        receiverScope.launch {
            try {
                val database = FintraceDatabase.getInstance(context)
