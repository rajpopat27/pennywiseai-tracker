    ...
    val uiState: StateFlow<AnalyticsUiState> = combine(
        ...
        if (dateRange == null) {
            ...
            transactionRepository.getTransactionsBetweenDates(
                ...
                val allCurrencies = CurrencyFormatter.sortCurrencies(
                ...
                val dbTransactionType = when (filterState.typeFilter) {
                    ...
                    TransactionTypeFilter.INCOME -> com.fintrace.app.data.database.entity.TransactionType.INCOME
                    TransactionTypeFilter.EXPENSE -> com.fintrace.app.data.database.entity.TransactionType.EXPENSE
                    TransactionTypeFilter.TRANSFER -> com.fintrace.app.data.database.entity.TransactionType.TRANSFER
                }
                ...
                val accountBreakdown = filteredTransactions
                    ...
                    .map { (accountKey, txns) ->
                        ...
                        val totalSpent = txns
                            .filter { it.transactionType == com.fintrace.app.data.database.entity.TransactionType.EXPENSE ||
                                      it.transactionType == com.fintrace.app.data.database.entity.TransactionType.EXPENSE }
                            .sumOf { it.amount.toDouble() }
                            .toBigDecimal()

                        val totalIncome = txns
                            .filter { it.transactionType == com.fintrace.app.data.database.entity.TransactionType.INCOME }
                            .sumOf { it.amount.toDouble() }
                            .toBigDecimal()
