...
import com.pennywiseai.tracker.data.mapper.toPendingEntity
import com.pennywiseai.tracker.data.mapper.toTransactionEntity
...
import com.pennywiseai.tracker.data.repository.PendingTransactionRepository
...
class PendingTransactionManager @Inject constructor(
    ...
    private val pennyWiseApplication = application as PennyWiseApplication
    ...
    private suspend fun processBalanceUpdate(
        ...
        try {
            ...
            val isCreditCard = entity.transactionType == TransactionType.CREDIT ||
                ...
                existingAccount?.isCreditCard == true && entity.transactionType == TransactionType.INCOME -> {
                    ...
                    when (entity.transactionType) {
                        ...
                        TransactionType.EXPENSE, TransactionType.INVESTMENT ->
                            (currentBalance - pending.amount).max(BigDecimal.ZERO)
                        TransactionType.CREDIT, TransactionType.TRANSFER -> currentBalance
                    }
                }
            }
