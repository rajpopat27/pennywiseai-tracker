...
class BankOfBarodaParser : BankParser() {
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            ...
            lowerMessage.contains("spent on your bobcard") -> TransactionType.EXPENSE
            lowerMessage.contains("bobcard") && lowerMessage.contains("spent") -> TransactionType.EXPENSE
            lowerMessage.contains("bobcard") && lowerMessage.contains("is spent") -> TransactionType.EXPENSE
