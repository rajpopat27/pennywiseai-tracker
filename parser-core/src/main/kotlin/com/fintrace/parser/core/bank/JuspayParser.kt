...
class JuspayParser : BankParser() {
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            ...
            lowerMessage.contains("credited") -> TransactionType.EXPENSE
            lowerMessage.contains("refunded") -> TransactionType.EXPENSE
            lowerMessage.contains("received") -> TransactionType.EXPENSE
            else -> null
        }
    }
