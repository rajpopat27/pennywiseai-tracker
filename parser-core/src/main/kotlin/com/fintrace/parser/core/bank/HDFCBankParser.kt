...
import com.fintrace.parser.core.CompiledPatterns
import com.fintrace.parser.core.MandateInfo
...
class HDFCBankParser : BankParser() {
    ...
    override fun extractTransactionType(message: String): TransactionType? {
        ...
        return when {
            ...
            lowerMessage.contains("block cc") || lowerMessage.contains("block pcc") -> TransactionType.EXPENSE

            // Legacy pattern for older format that explicitly says "spent on card"
            lowerMessage.contains("spent on card") && !lowerMessage.contains("block dc") -> TransactionType.EXPENSE
